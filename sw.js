const CACHE='kouzelna-zahrada-v22';
const ASSETS=[
  './','./index.html','./phaser.html','./manifest.json',
  './css/game.css','./css/phaser.css?v=22',
  './js/main.js','./js/data.js','./js/storage.js','./js/art.js',
  './js/control-mode-v21.js?v=22','./js/external-assets-v15.js?v=22',
  './js/phaser-game-v10.js?v=22','./js/visual-overlays-v22.js?v=22',
  './assets/generated/lili.png.b64?v=22',
  './assets/generated/star-v16.png.b64?v=22',
  './assets/generated/key-v16.png.b64?v=22',
  './assets/generated/pond-v16.png.b64?v=22',
  './assets/generated/gate-v16.png.b64?v=22'
];
